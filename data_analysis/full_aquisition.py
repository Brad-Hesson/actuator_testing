...
from meta_profile import get_aquisition_datetime, get_meta_profile, get_aquisition_time_vector
...
if __name__ == "__main__":
    ...
    plt.subplot(2,1,2)
    all_data[:,1] -= np.interp(all_data[:,0], vs[:,0], vs[:,1])
    plt.plot(all_data[:,0], all_data[:,1]*1000*1000*1000)
    plt.show()
